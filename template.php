...
/**
 * mobile_example is a mobile_garland inspired mobile optimized Drupal theme.
 */
 ...
 */
function mobile_example_toplinks($links, $attributes = array('class' => 'links')) {
